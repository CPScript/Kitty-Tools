...
print(" ")
print(f"{r}|=========================\ ")
sprint(f"{r}|NEWS: {y}Want more? purchase my software here: https://giveme1taa.wixsite.com/orbit{r}  |||  {y}Please star this repo so more people can enjoy it <3")
print(f"{r}|=========================/ ")
print(" ")
print(" ")
print(" ")
...
print("||| \\---------/")
print(" ")
print("[3] Flooder (Download required)")
print("||| \\-----/")
print(" ")
